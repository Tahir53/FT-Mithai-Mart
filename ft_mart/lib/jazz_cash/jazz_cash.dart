...
class Jazz_cash extends StatefulWidget {
  Jazz_cash({Key, key, }) : super(key: key);
...
class _Jazz_cashState extends State<Jazz_cash> {
  ...
  payment() async{
    ...
    String pp_Description="FT Mithai Mart Payment";
    String pp_Language="EN";
    String pp_MerchantID="MC92142";
    String pp_Password="yf2su410d5";
    ...
    String ppmpf_1="03006215253";
    String IntegeritySalt = "81uc45cu80";
    String and = '&';
    String superdata=
        IntegeritySalt+and+
            pp_Amount+and+
        ...
        Container(
          child: Center(
            child: MaterialButton(
              ...
              child: const Text("Click to pay via JazzCash"),
            ),
          ),
        )
